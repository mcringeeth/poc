...
class FilebaseService:
    def __init__(self, filebase_access_key_id, filebase_secret_access_key, bucket_name="vchars", remote_file_key="hash_list.json", endpoint_url='https://s3.filebase.com'):
